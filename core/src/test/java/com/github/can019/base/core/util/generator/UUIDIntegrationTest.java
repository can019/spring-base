package com.github.can019.base.core.util.generator;
...
public class UUIDIntegrationTest {
    ...
    void uuidV1은_uuid_스펙과_같아야한다(){
        java.util.UUID uuidv1 = com.github.can019.base.core.util.generator.UUID.generateSequentialUUIDV1();
    }
    ...
    void 하이픈이_제거된_sequential_uuid는_늦게만들어진_것이_더_커야한다(){
        ...
        for(int i = 0; i < TEST_TIME; i++){
            originArrayList.add(com.github.can019.base.core.util.generator.UUID.generateSequentialUUIDV1WithoutHyphen());
        }
